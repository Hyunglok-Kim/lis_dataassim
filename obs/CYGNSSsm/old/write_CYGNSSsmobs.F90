...
!BOP
! 
! !ROUTINE: write_CYGNSSsmobs
! \label{write_CYGNSSsmobs}
! 
! !REVISION HISTORY: 
! 25Jan2008: Sujay Kumar; Initial Specification
! 
! !INTERFACE: 
subroutine write_CYGNSSsmobs(n, k, OBS_State)
! !USES: 
  use ESMF
  use LIS_coreMod
  use LIS_logMod
...
!EOP
  ...
  if(data_update) then 
     ...
     if(LIS_masterproc) then 
        ...
        call CYGNSS_smobsname(n,k,obsname)        
...
end subroutine write_CYGNSSsmobs

!BOP
! !ROUTINE: CYGNSS_smobsname
! \label{CYGNSS_smobsname}
! 
! !INTERFACE: 
subroutine CYGNSS_smobsname(n,k,obsname)
! !USES: 
...
end subroutine CYGNSS_smobsname
